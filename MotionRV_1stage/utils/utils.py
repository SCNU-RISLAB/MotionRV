...
def make_logdir(FLAGS, resume_train=False):
    try:  
        if resume_train:  # resume_train=False
            if FLAGS.pretrained == "":
...
def get_args(flags=None):
    ...
    parser.add_argument(
        '--dataset', '-d', type=str,
        required=False,
        default="/home/user/dataset/kitti_dataset/",
    ...
    if flags == "train":
        ...
        parser.add_argument(
            ...
            required=False,
            default="/data/zlf/mos3d/mos3d_v3/train_yaml/mos_coarse_stage.yml",
            help='Architecture yaml cfg file. See /config/arch for sample. No default.')

        parser.add_argument(
            '--data_cfg', '-dc', type=str,
            required=False,
            default="/data/zlf/mos3d/mos3d_v3/config/labels/semantic-kitti-mos.raw.yaml",
