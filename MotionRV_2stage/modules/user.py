    ...
    def __init__(self, ARCH, DATA, datadir, outputdir, modeldir, split, point_refine=False):
        ...
        with torch.no_grad():
            ...
            if not point_refine:
                ...
                print("\033[32m Using [[ MotionRV_valid_best ]] model! \033[0m")
                ...
                self.model.load_state_dict({f"module.{k}":v for k,v in w_dict['main_state_dict'].items()}, strict=False)
                
                print("\033[32m Using [[ MotionRV_refine_module_valid_best ]] model! \033[0m")
